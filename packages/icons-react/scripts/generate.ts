import * as allIconDefs from "infra-design-svgs";
import { IconDefinition } from "infra-design-svgs/es/types";
...
import <%= svgIdentifier %>Svg from 'infra-design-svgs/lib/asn/<%= svgIdentifier %>';

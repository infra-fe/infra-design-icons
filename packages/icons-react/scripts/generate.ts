import * as allIconDefs from '@infra-design/icons-svg';
import { IconDefinition } from '@infra-design/icons-svg/es/types';
...
import <%= svgIdentifier %>Svg from '@infra-design/icons-svg/lib/asn/<%= svgIdentifier %>';
